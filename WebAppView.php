...
class WebAppView
{
    ...
    protected function buildCssUrls($cdnUrl)
    {
        return $this->buildAssetUrls($cdnUrl, [$this->css->getFile(), $this->localeCss->getFile()]);
    }

    protected function buildJsUrls($cdnUrl)
    {
        return $this->buildAssetUrls($cdnUrl, [$this->js->getFile(), $this->localeJs->getFile()]);
    }
